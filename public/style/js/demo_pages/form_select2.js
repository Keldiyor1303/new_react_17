...
let currentPage1 = window.location.href;
setInterval(function () {
    if (currentPage1 !== window.location.href) {
        // page has changed, set new page as 'current'
        currentPage1 = location.href;
        // do your thing..
        Select2Selects.init();
    }
}, 1);
...
document.addEventListener('mouseenter', function () {
    Select2Selects.init();
    document.querySelector('#myFormInput')?.addEventListener('click', () => {
        setTimeout(() => {
            Select2Selects.init();
        }, 1);
    })
    // ijroContent
    document.querySelector('.yangiQushishIjro')?.addEventListener('click', () => {
        setTimeout(() => {
            Select2Selects.init();
        }, 1);
    })
...
// uzgartirish id
document.querySelector('#uzgartirish')?.addEventListener('click', () => {
    setTimeout(() => {
        Select2Selects.init();
    }, 1);
})
