...
let currentPage2 = window.location.href;
setInterval(function () {
    if (currentPage2 != window.location.href) {
        // page has changed, set new page as 'current'
        currentPage2 = location.href;
        // do your thing..
        DateTimePickers.init();
    }
}, 1);
...
document.addEventListener('mouseenter', function () {
    // DateTimePickers.init();
    // IjroContent.jsx
    document.querySelector('#yangiQushishIjroBtn')?.addEventListener('click', () => {
        setTimeout(() => {
            DateTimePickers.init();
        }, 1);
    })
