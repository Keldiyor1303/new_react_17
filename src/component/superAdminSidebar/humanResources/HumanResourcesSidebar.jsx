            ...
            <div className="sidebar-content">
                ...
                <div className="sidebar-section">
                    <ul className="nav nav-sidebar" data-nav-type="accordion">
                        ...
                        <li className="nav-item nav-item-submenu">
                            <a href="#1" className="nav-link"><i className="icon-home4"></i> <span>Kadrlar bo'limi</span></a>

                            <ul className="nav nav-group-sub">
                                <li className="nav-item">
                                    <a href="index.html" className="nav-link">Tashkiliy tuzilma</a>
                                </li>
                                <li className="nav-item">
                                    <a href="#1" className="nav-link">Xodimlar</a>
                                </li>
                                <li className="nav-item">
                                    <a href="#1" className="nav-link">Zaxira xodimlar</a>
                                </li>
                                <li className="nav-item">
                                    <a href="#1" className="nav-link">Mukofotlash</a>
                                </li>
                            </ul>
                        </li>
                        <li className="nav-item nav-item-submenu">
                        ...
                        <li className="nav-item nav-item-submenu">
                            ...
                            <ul className="nav nav-group-sub">
                                ...
                                <li className="nav-item">
                                    <a href="#1" className="nav-link">Xodimlar qabuli</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
