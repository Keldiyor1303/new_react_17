...
export default function FuqaroNazoratContent() {
                                        ...
                                        <tr id="kor">
                                            ...
                                            <td className="harakat">
                                                <div className="icon d-flex justify-content-center align-items-center">
                                                    ...
                                                    {/* <i className="icon-pencil5 cursor-pointer infoBtn bg-dark d-flex align-items-center justify-content-center" title="O'chirish" /> */}
