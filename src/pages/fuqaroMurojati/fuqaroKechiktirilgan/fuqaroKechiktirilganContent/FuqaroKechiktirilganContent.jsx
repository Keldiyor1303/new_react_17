...
export default function FuqaroKechiktirilganContent() {
    ...
    return (
        <div className="content mb-5">
            ...
            <h3 style={{ margin: "10px 0 0 20px", fontWeight: "bold", textTransform: "upperCase" }}>Kechiktirilgan</h3>
                                ...
                                <table id="myTable" className="table table-bordered table-striped table-hover Tab" >
                                    ...
                                    <tbody>
                                        <tr id="kor">
                                            ...
                                            <td data-maxlength="5" className="qiqacha">
                                            ...
                                            <td className="harakat">
                                                <div className="icon d-flex justify-content-center align-items-center">
                                                    ...
                                                    {/* <i className="icon-pencil5 infoBtn cursor-pointer bg-dark d-flex align-items-center justify-content-center" title="O'zgartirish" /> */}
                                                    {/* <i className="icon-trash infoBtn cursor-pointer bg-dark d-flex align-items-center justify-content-center" title="O'chirish" /> */}
