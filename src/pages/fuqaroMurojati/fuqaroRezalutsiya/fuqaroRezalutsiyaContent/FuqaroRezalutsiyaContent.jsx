...
export default function FuqaroRezalutsiyaContent() {
    ...
    return (
        <div className="content mb-5">
            {/* <!-- Sobir Suxayl</div> Header qismini shu shuyer dan yozasizlar-- > */}
                                        ...
                                        <tr id="kor">
                                            ...
                                            <td className="harakat">
                                                <div className="icon d-flex justify-content-center align-items-center">
                                                    <Link to="/fuqaro/murojati/rezalutsiya/kurish" className="infoBtn bg-dark" data-popup="tooltip" data-bs-placement="top" title="Ko'rish">
                                                        <span><i className="icon-eye2"></i></span>
                                                    </Link>
                                                    {/* <a href="./rezalutsiyaKorish.html" className="infoBtn bg-dark" data-bs-toggle="tooltip" data-popup="tooltip" data-bs-placement="top" title="Ko'rish"><span><i className="icon-eye2"></i></span> </a> */}
