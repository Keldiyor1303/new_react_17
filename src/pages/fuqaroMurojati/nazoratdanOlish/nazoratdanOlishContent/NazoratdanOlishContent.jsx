                                        ...
                                        <tr>
                                            <th>
                                                <div className="form-group form-group-feedback form-group-feedback-left inp">
                                                    <input type="text" className="form-control form-control-lg" onChange={(e) => xujjatFun(e.target.value)} id="xujjat" placeholder="Murojaat turi" />
                                            ...
                                            <th>
                                                <div className="form-group form-group-feedback form-group-feedback-left inp">
                                                    <input type="text" className="form-control form-control-lg" id="korrespondent2" onChange={(e) => korresFun(e.target.value)} placeholder="Ariza beruvchi" />
                                                    <div className="form-control-feedback form-control-feedback-lg">
                                                        <i className="icon-search4"></i>
                                                    </div>
                                                </div>
                                            ...
                                            <th>
                                                <div className="form-group form-group-feedback form-group-feedback-left inp">
                                                    <input type="text" className="form-control form-control-lg" placeholder="Reg № / sana" id="qisqacha" onChange={(e) => qisqachaFun(e.target.value)} />
                                                    <div className="form-control-feedback form-control-feedback-lg">
                                                        <i className="icon-search4"></i>
                                                    </div>
                                                </div>
                                            ...
                                            <th>
                                                <div className="form-group form-group-feedback form-group-feedback-left inp">
                                                    ...
                                                    <div className="dropdown-menu drop1">
                                ...
                                <table id="myTable" className="table table-bordered table-striped table-hover Tab" >
                                    ...
                                    <tbody>
                                        <tr id="kor">
                                            ...
                                            <td className="text-color qabul">Xalq Qabulxonasi</td>
                                            <td className="text-center ariza">
                                                Eshmatov Toshmat Shamurodvich
                                            </td>
                                            <td className="mur">Ariza</td>
                                            <td data-maxlength="5" className="qisqacha">
                                            ...
                                            <td className="harakat">
                                                <div className="icon d-flex justify-content-center align-items-center">
                                                    ...
                                                    {/* <i className="icon-eye2 infoBtn bg-dark cursor-pointer d-flex align-items-center justify-content-center" title="Ko'rish" /> */}
                                                    {/* <i className="icon-pencil5 infoBtn bg-dark cursor-pointer d-flex align-items-center justify-content-center" title="O'zgartirish" /> */}
                                                    {/* <i className="icon-trash infoBtn bg-dark cursor-pointer d-flex align-items-center justify-content-center" title="O'chirish" /> */}
