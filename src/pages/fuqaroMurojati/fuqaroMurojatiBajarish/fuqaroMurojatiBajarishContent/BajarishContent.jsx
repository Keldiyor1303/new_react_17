...
export default function BajarishContent() {
    ...
    return (
        <div className="content mb-5">
            ...
            <h3 style={{ margin: "10px 0 0 20px", fontWeight: "bold", textTransform: "upperCase" }}>Bajarish Uchun</h3>
                                        ...
                                        <tr id="kor">
                                            ...
                                            <td className="harakat">
                                                <div className="icon d-flex justify-content-center align-items-center">
                                                    ...
                                                    {/* <i className="icon-pencil5 cursor-pointer infoBtn bg-dark d-flex align-items-center justify-content-center" title="O'zgartirish" /> */}
                                                    {/* <i className="icon-trash cursor-pointer infoBtn bg-dark d-flex align-items-center justify-content-center" title="O'chirish" /> */}
