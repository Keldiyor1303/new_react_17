...
export default function ArxivContent() {
    return (
            ...
            <div className="card-body">
                <ul className="nav nav-tabs nav-tabs-solid nav-tabs-solid-custom bg-primary NavLink">
                    ...
                    <li className="nav-item">
                        {/* <i className="icon-folder-upload nav-link mr-1 d-flex align-items-center justify-content-center"></i> Chiquvchi */}
                                    ...
                                    <div className="row">
                                        <div className="col-lg-3">
                                            <div className="form-group">
                                                {/* <select data-placeholder="Korrespondent" className="form-control select-search  form-control-outline select">
                                                    <option></option>
                                                    <optgroup label="Korrespondent">
                                                        <option value="AZ">O'zbekiston Respublikasi Vazirlar Mahkamasi</option>
                                                        <option value="CO">Xalq Deputatlari Buxoro Tuman Kengashi deputat so'rovi</option>
                                                    </optgroup>
                                                </select> */}
                                                <Select
