...
export default function ResolutionContent() {
    ...
    useEffect(async () => {
        await axiosInstance.post("search/resolution/" + JSON.parse(localStorage.getItem('ids')), {
            correspondentName: '',
            shortDescription: '',
            out_number: '',
            out_date: '',
    ...
    useEffect(() => {
        const getData = async () => {
            const res = await axiosInstance.get(`mainPage/allMyTask/${localStorage.getItem('ids')}`, {
                headers: {
                    Authorization: "Bearer " + currentUser
                }
            })
    ...
    const handlePageClick = async (e) => {
        try {
            const res = await axiosInstance.get(`mainPage/allMyTask/${JSON.parse(localStorage.getItem('ids'))}?page=${e.selected}`, {
                headers: {
                    Authorization: "Bearer " + currentUser
                }
            })
