...
export default function VazifalarJarayondaContent({ itemsPerPage }) {
    ...
    useEffect(() => {
        const getData = async () => {
            const res = await axiosInstance.get(`mainPage/inProcess/${localStorage.getItem('ids')}`, {
                headers: {
    ...
    const handlePageClick = async (e) => {
        try {
            const res = await axiosInstance.get(`mainPage/inProcess/${JSON.parse(localStorage.getItem('ids'))}?page=${e.selected}`, {
                headers: {
                    Authorization: "Bearer " + currentUser
                }
            })
    ...
    const korresFun = (value) => {
        ...
        // input = document.getElementById("korrespondent2");
    ...
    const xujjatFun = (value) => {
        ...
        setFayl(value);
        // var input, filter, table, tr, td, i, txtValue;
        // input = document.getElementById("xujjat");
        // filter = input.value.toUpperCase();
        // table = document.getElementById("myTable");
        // tr = table.getElementsByTagName("tr");
        // for (i = 0; i < tr.length; i++) {
    ...
    const qisqachaFun = (value) => {
        ...
        setSana(value);
        // var input, filter, table, tr, td, i, txtValue;
        // input = document.getElementById("qisqacha");
        // filter = input.value.toUpperCase();
        // table = document.getElementById("myTable");
        // tr = table.getElementsByTagName("tr");
        // for (i = 0; i < tr.length; i++) {
