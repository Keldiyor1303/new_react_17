...
export default function Bajarilmagan1kunKechContent({ itemsPerPage }) {
    ...
    useEffect(() => {
        const getData = async () => {
            const res = await axiosInstance.get(`mainPage/lateOneDay/${localStorage.getItem('ids')}`, {
                headers: {
    ...
    const handlePageClick = async (e) => {
        try {
            const res = await axiosInstance.get(`mainPage/lateOneDay/${JSON.parse(localStorage.getItem('ids'))}?page=${e.selected}`, {
                headers: {
                    Authorization: "Bearer " + currentUser
                }
            })
    ...
    return (
        <div className="content mb-5">
            <h3 style={{ margin: "10px 0 0 20px", fontWeight: "bold", textTransform: "upperCase" }}>1 kun kechikkan</h3>
                                            ...
                                            <th style={{ width: '350px' }}>
                                                <div
                                                    ...
                                                    <button className="btn btn-primary "
                                                        ...
                                                        <i className="icon-menu9" style={{ fontSize: "18px" }}></i>
                                                    </button>
