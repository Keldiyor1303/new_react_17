...
export default function ViloyatlarContent() {
    ...
    return (
        <div className="content mb-5">
            <h3 style={{ margin: "10px 0 0 20px", fontWeight: "bold", textTransform: "upperCase" }}>Viloyatlar</h3>
                                            ...
                                            <tr key={index} className="text-center">
                                                ...
                                                <td>
                                                    <div className="icon d-flex justify-content-center align-items-center">
                                                        ...
                                                        <a href="#1" className="infoBtn bg-dark" data-popup="tooltip" title="O'chirish" data-toggle="modal" data-target="#modal_theme_primary1"><i className="icon-trash"></i> </a>
                                                    </div>
                                                    {/* <i className="icon-pencil5 btn btn-dark mr-1 cursor-pointer" title="O'zgartirish" onClick={() => setUpdateModal({ open: true, obj: dat })} /> */}
