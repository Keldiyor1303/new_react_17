...
export default function TashkilotlarContent() {
    return (
            ...
            <div className="card-body">
                <ul className="nav nav-tabs nav-tabs-solid nav-tabs-solid-custom bg-primary NavLink d-flex align-items-center justify-content-between">
                    ...
                    <li className="nav-item mr-3">
                        <button data-toggle="modal" data-target="#yonalish" style={{ fontWeight: "bold", textTransform: "upperCase", color: "#fff" }}><i className="icon-plus2"></i> Yo'nalish Qo'shish</button>
                        <button data-toggle="modal" className="ml-2" data-target="#modal_theme_primary" style={{ fontWeight: "bold", textTransform: "upperCase", color: "#fff" }}><i className="icon-plus2"></i> Tashkilot Qo'shish</button>
                        {/* <!-- Modal --> */}
                                            ...
                                            <div className="row mt-4">
                                                ...
                                                <div className="col-lg-12">
                                                    <div className="custom-control custom-checkbox mb-2">
                                                        ...
                                                        <label className="custom-control-label" htmlFor="qTash">Quyi tashkilot qo'shish</label>
                                                    </div>
                                                </div>
                                                <div className="col-lg-12 mt-3" id="passposrtMalumotlari" style={{ display: "none" }}>
                                                    <div className="form-group form-group-floating row">
                                                        <div className="col-lg-12">
                                                            <div className="position-relative">
                                                                <select data-placeholder="Tuman tashkilot" className="form-control select-search form-control-outline select">
                                                                    <option></option>
                                                            ...
                                                            <div className="card">
                                                                ...
                                                                <div id="bTashkilot" className="collapse " data-parent="#bTashkilot">
                                                                    <div className="card-body">
                                                                        ...
                                                                        <table className="table datatable-row-full  mt-3 table-bordered table-striped table-hover Tab text-center" id="myTable">
                                                                            <thead>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td>1</td>
                                                                                    <td>
                                                                                        <img src="/style/images/gerb.svg" style={{ width: "30%" }} alt="" />
                                                                                    </td>
                                                                                    <td>malumot</td>
                                                                                    <td>malumot</td>
                                                                                    <td>Rahbar</td>
                                                                                    <td>
                                                                                        {/* <Link to="/super_base_admin_tashkilotlar-kurish" className="btn btn-dark" title="Ko'rish" data-animation="false">
                                                                                            <i className="icon-eye"></i>
                                                                                        </Link> */}
                                                                                        <i className="icon-eye btn btn-dark d-flex align-items-center justify-content-center cursor-pointer" title="Ko'rish"/>
                                                                                        {/* <a href="#" class="btn btn-dark" data-popup="tooltip" title="Ko'rish" data-animation="false"><i class="icon-eye"></i></a> */}
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
