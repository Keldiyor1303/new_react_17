...
export default function BarchasiTopshiriqlarContent() {
            ...
            <div className="card-body">
                <ul className="nav nav-tabs nav-tabs-solid nav-tabs-solid-custom bg-primary NavLink">
                    ...
                    <li className="nav-item">
                        <NavLink to={`/jurnallar_topshiriqlar/${params.id}`} className="nav-link ml-2d-flex align-items-center" activeClassName="NavLinkLi">
