...
export default function BarchasiDetailContent({ itemsPerPage }) {
    ...
    // id bo'yicha barcha malumotlarni o'qib olish
    // useEffect(() => {
    //     axiosInstance.get("journal/" + params.id, {
    //         headers: {
    //             Authorization: "Bearer " + currentUser
    ...
    const closeJournal = () => {
        axiosInstance.patch("journal/close/" + params.id, {}, {
            headers: {
                Authorization: "Bearer " + currentUser
            }
        })
    ...
    const sendArchive = () => {
        axiosInstance.patch("journal/archive/" + params.id, {}, {
            headers: {
                Authorization: "Bearer " + currentUser
            }
        })
            ...
            <div className="card-body">
                <ul className="nav nav-tabs nav-tabs-solid nav-tabs-solid-custom bg-primary NavLink">
                    ...
                    <li className="nav-item">
                        <NavLink to={`/jurnallar_kurish/${params.id}`} className="nav-link align-items-center" activeClassName="NavLinkLi">
