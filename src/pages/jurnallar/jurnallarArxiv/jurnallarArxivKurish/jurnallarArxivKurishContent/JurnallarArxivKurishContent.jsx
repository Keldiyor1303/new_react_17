...
export default function JurnallarArxivKurishContent({ itemsPerPage }) {
            ...
            <div className="card-body">
                <ul className="nav nav-tabs nav-tabs-solid nav-tabs-solid-custom bg-primary NavLink">
                    ...
                    <li className="nav-item">
                        <NavLink to={`/jurnallar/arxiv/ko'rish/${params.id}`} className="nav-link align-items-center" activeClassName="NavLinkLi">
