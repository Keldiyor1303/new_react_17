...
export default function JurnallarArxivContent() {
                                            ...
                                            <tr style={{ fontSize: "15px" }} className="text-center">
                                                ...
                                                <td>
                                                    <div className="icon d-flex justify-content-center align-items-center">
                                                        <Link to={`/jurnallar/arxiv/ko'rish/${dat?.id}`} className="infoBtn bg-dark" data-bs-toggle="tooltip" data-popup="tooltip" data-bs-placement="top" title="Ko'rish">
                                                            <span><i className="icon-eye2"></i></span>
                                                        </Link>
                                                        <Link to={`/jurnallar_arxiv_detail/${dat?.id}`} className="infoBtn bg-dark" data-bs-toggle="tooltip" data-popup="tooltip" data-bs-placement="top" title="Log">
