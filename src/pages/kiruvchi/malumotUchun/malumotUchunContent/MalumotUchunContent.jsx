...
export default function MalumotUchunContent() {
    ...
    useEffect(() => {
        const getData = async () => {
            try {
                const res = await axiosInstance.post("search/forInfo/" + JSON.parse(localStorage.getItem('ids')), {
                    correspondentName: '',
                    shortDescription: '',
                    out_number: '',
                    out_date: '',
    ...
    const handlePageClick = async (e) => {
        try {
            const res = await axiosInstance.post(`search/forInfo/${JSON.parse(localStorage.getItem('ids'))}?page=` + e.selected, {
                correspondentName: '',
                shortDescription: '',
                out_number: '',
                out_date: '',
    ...
    return (
        <div className="content mb-5">
            <h3 style={{margin: "10px 0 0 20px", fontWeight: "bold", textTransform: "upperCase"}}>Ma'lumot uchun</h3>
                                        ...
                                        <tr key={index}>
                                            ...
                                            <td className="harakat">
                                                <div className="icon d-flex justify-content-center align-items-center ">
                                                    <Link to={`/kiruvchi_bajarish_ijro/${dat?.id}/malumot`}
