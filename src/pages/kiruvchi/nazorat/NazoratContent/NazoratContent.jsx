...
export default function NazoratContent() {
    ...
    useEffect(() => {
        const getData = async () => {
            try {
                const res = await axiosInstance.post("search/inControl/" + JSON.parse(localStorage.getItem('ids')), {
                    correspondentName: '',
                    shortDescription: '',
                    out_number: '',
                    out_date: '',
    ...
    const handlePageClick = async (e) => {
        try {
            const res = await axiosInstance.post(`search/inControl/${JSON.parse(localStorage.getItem('ids'))}?page=` + e.selected, {
                correspondentName: '',
                shortDescription: '',
                out_number: '',
                out_date: '',
                                        ...
                                        <tr key={index}>
                                            ...
                                            <td className="harakat">
                                                <div className="icon d-flex justify-content-center align-items-center ">
                                                    <Link to={`/kiruvchi_bajarish_ijro/${dat.id}/nazorat`}
