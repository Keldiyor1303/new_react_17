...
export default function KechiktirilganContent() {
    ...
    useEffect(() => {
        const getData = async () => {
            try {
                const res = await axiosInstance.post("search/notDone/" + JSON.parse(localStorage.getItem('ids')), {
                    correspondentName: '',
                    shortDescription: '',
                    out_number: '',
                    out_date: '',
    ...
    const handlePageClick = async (e) => {
        try {
            const res = await axiosInstance.post(`search/notDone/${JSON.parse(localStorage.getItem('ids'))}?page=` + e.selected, {
                correspondentName: '',
                shortDescription: '',
                out_number: '',
                out_date: '',
    ...
    return (
        <div className="content mb-5">
            <h3 style={{ margin: "10px 0 0 20px", fontWeight: "bold", textTransform: "upperCase" }}>Bajarilmagan</h3>
                                    ...
                                    <tbody>
                                        {data.content?.length > 0 && data.content?.map((dat, index) => (
                                            <tr key={index}>
                                                                ...
                                                                <>
                                                                    {hujjat?.extention?.split('/')[hujjat?.extention?.split('/').length - 1] === "pdf" ? (
                                                                        <span className="d-flex align-items-center cursor-pointer mb-1">
                                                                            ...
                                                                            <a className="pt-1" href={url + "/api/file/view/" + hujjat?.generateName} target="_blank" rel="noopener noreferrer">PDF FILE</a>
                                                                        </span>
                                                                        ...
                                                                        <span className="d-flex align-items-center cursor-pointer mb-1">
                                                                            <i className="far fa-file-word mr-1 fa-2x wordIcon" style={{ fontSize: "20px" }} />
                                                                            <a className="pt-1" href={url + "/api/file/view/" + hujjat?.generateName} target="_blank" rel="noopener noreferrer">WORD FILE</a>
                                                                        </span>
                                                                        ...
                                                                        <span className="d-flex align-items-center cursor-pointer mb-1">
                                                                            <i className="far fa-file-excel mr-1 fa-2x excelIcon" style={{ fontSize: "20px" }} />
                                                                            <a className="pt-1" href={url + "/api/file/view/" + hujjat?.generateName} target="_blank" rel="noopener noreferrer">EXCEL FILE</a>
                                                                        </span>
                                                                        ...
                                                                        <span className="d-flex align-items-center cursor-pointer mb-1">
                                                                            <i className="far fa-file-powerpoint mr-1 fa-2x pptIcon" style={{ fontSize: "20px" }} />
                                                                            <a className="pt-1" href={url + "/api/file/view/" + hujjat?.generateName} target="_blank" rel="noopener noreferrer">POWERPOINT FILE</a>
                                                                        </span>
                                                                    ) : (
                                                                        <span className="d-flex align-items-center cursor-pointer mb-1">
                                                                            <i className="far fa-file-archive mr-1 fa-2x rarIcon" style={{ fontSize: "20px" }}></i>
                                                                            <a className="pt-1" href={url + "/api/file/view/" + hujjat?.generateName} target="_blank" rel="noopener noreferrer">ZIP, RAR FILE</a>
                                                                        </span>
                                                                    )}
                                                                </>
                                                            )}
                                                ...
                                                <td style={{ textAlign: "justify", wordWrap: "break-word" }} className="qisqacha">
                                                ...
                                                <td className="text-center ijrochi ijrochi1">
                                                    {dat?.inExecutorShortInfoDtos?.length > 0 && dat?.inExecutorShortInfoDtos?.map((d, i) => (
                                                        <>
                                                            {!d.isDirect && (
                                                                <p style={{ margin: "0", borderColor: "#ddd", height: "100%", marginBottom: "5px", textAlign: "left" }}
                                                    ...
                                                    {dat?.inExecutorShortInfoDtos?.length > 0 && dat?.inExecutorShortInfoDtos?.map((d, i) => (
                                                        <>
                                                            {d?.isDirect && (
                                                                <p style={{ margin: "0", borderColor: "#ddd", height: "100%", textAlign: "left", marginBottom: "5px" }}
                                                                    className="d-flex align-items-center">
                                                                    <span style={{ fontSize: "14px" }}>{(d?.firstName && d?.firstName?.length > 1) ? ((((d?.firstName[0].toUpperCase() === "S" || d?.firstName[0].toUpperCase() === "C") && d?.firstName[1].toUpperCase() === "H")) ? d?.firstName.substring(0, 2) + ". " : d?.firstName.substring(0, 1) + ". ") : ""} {d?.lastName}</span>
                                                                    <span className="badge ml-1 status text-white"
                                                                        style={{ backgroundColor: status.filter((s, i) => s.englishName === d?.documentStatusName)[0]?.color }}>{status.filter((s, i) => s.englishName === d?.documentStatusName)[0]?.LatinName}</span>
                                                ...
                                                <td className="harakat">
                                                    <div className="icon d-flex justify-content-center align-items-center ">
                                                        <Link to={`/kiruvchi_bajarish_ijro/${dat?.id}/bajarilmagan`} className="infoBtn bg-dark" title="Ko'rish" data-bs-toggle="tooltip" data-popup="tooltip" data-bs-placement="top">
