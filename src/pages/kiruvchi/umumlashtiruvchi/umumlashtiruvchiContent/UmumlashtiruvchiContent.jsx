...
export default function UmumlashtiruvchiContent() {
    ...
    useEffect(() => {
        const getData = async () => {
            try {
                const res = await axiosInstance.post("search/generaller/" + JSON.parse(localStorage.getItem('ids')), {
                    correspondentName: '',
                    shortDescription: '',
                    out_number: '',
                    out_date: '',
    ...
    const handlePageClick = async (event) => {
        try {
            const res = await axiosInstance.post(`search/generaller/${JSON.parse(localStorage.getItem('ids'))}?page=` + event.selected, {
                correspondentName: '',
                shortDescription: '',
                out_number: '',
                out_date: '',
    ...
    return (
        <div className="content mb-5">
            <h3 style={{margin: "10px 0 0 20px", fontWeight: "bold", textTransform: "upperCase"}}>Umumlashtiruvchi</h3>
                                        ...
                                        <tr key={index}>
                                            ...
                                            <td className="harakat">
                                                <div className="icon d-flex justify-content-center align-items-center ">
                                                    <Link to={`/kiruvchi_bajarish_ijro/${dat?.id}/umumlashtiruvchi`}
